...
@register_command(
    "neon branch preflight",
    is_preview=True,
)
class Preflight(AAZCommand):
    """Run preflight validation for branch operations.
    """
    ...
    def _execute_operations(self):
        self.pre_operations()
        self.BranchesPreflightValidation(ctx=self.ctx)()
    ...
    class BranchesPreflightValidation(AAZHttpOperation):
        ...
        def url(self):
            return self.client.format_url(
                "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Neon.Postgres/organizations/{organizationName}/projects/{projectName}/branches/{branchName}/preflight",
                **self.url_parameters
            )
...
class _PreflightHelper:
    """Helper class for Preflight"""
